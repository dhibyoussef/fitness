<?php
$pageTitle = $pageTitle ?? 'Delete Meal Plan';
$id = $id ?? 0;
$name = $name ?? '';
...
<div class="container mx-auto py-8">
    ...
    <div class="card shadow-sm p-4 animate__animated animate__fadeInUp">
        <p>Are you sure you want to delete "<strong><?php echo htmlspecialchars($name); ?></strong>"? This action cannot be undone.</p>

        <form method="POST" action="/nutrition/delete/<?php echo htmlspecialchars($id); ?>">
            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf_token); ?>">
            <input type="hidden" name="confirm" value="yes">
            <div class="d-flex justify-content-end gap-2">
                <a href="/nutrition/index" class="btn btn-secondary">No, Cancel</a> <!-- Fixed: Correct route -->
