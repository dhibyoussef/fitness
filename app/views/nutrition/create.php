<?php
$pageTitle = $pageTitle ?? 'Create Meal Plan';
    ...
    <div class="container">
        ...
        <form method="POST" action="/nutrition/create" class="card shadow-sm p-4 animate__animated animate__fadeInUp">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="calories" id="calories" class="form-control" value="<?php echo htmlspecialchars($_POST['calories'] ?? ''); ?>" required>
            </div>

            <div class="mb-3">
                <label for="protein" class="form-label">Protein (g)</label>
                <input type="number" name="protein" id="protein" class="form-control" step="0.1" value="<?php echo htmlspecialchars($_POST['protein'] ?? ''); ?>">
            </div>

            <div class="mb-3">
                <label for="carbs" class="form-label">Carbs (g)</label>
                <input type="number" name="carbs" id="carbs" class="form-control" step="0.1" value="<?php echo htmlspecialchars($_POST['carbs'] ?? ''); ?>">
            </div>

            <div class="mb-3">
                <label for="fat" class="form-label">Fat (g)</label>
                <input type="number" name="fat" id="fat" class="form-control" step="0.1" value="<?php echo htmlspecialchars($_POST['fat'] ?? ''); ?>">
            </div>
