<?php
$pageTitle = $pageTitle ?? 'Create Workout';
$exercises = $exercises ?? [];
...
<div class="sidebar">
    ...
    <ul class="nav flex-column">
        <li class="nav-item">
            <a href="/workouts/index" class="nav-link <?php echo strpos($_SERVER['REQUEST_URI'], '/workouts/index') !== false ? 'active' : ''; ?>">
                <i class="fas fa-dumbbell mr-2"></i> Workouts
            </a>
        </li>
        <li class="nav-item">
            <a href="/workout/create" class="nav-link <?php echo strpos($_SERVER['REQUEST_URI'], '/workout/create') !== false ? 'active' : ''; ?>">
        ...
        <li class="nav-item">
            <a href="/progress/index" class="nav-link <?php echo strpos($_SERVER['REQUEST_URI'], '/progress') !== false ? 'active' : ''; ?>">
...
<div class="content">
    <div class="form-container">
        ...
        <form method="POST" action="/workout/create" class="card">
            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf_token); ?>">
            ...
            <div class="mb-4" id="exercise-container">
                ...
                <div class="exercise-row">
                    ...
                    <input type="text" name="exercises[0][reps]" placeholder="e.g., 10 or 8-12" class="form-control">
                </div>
