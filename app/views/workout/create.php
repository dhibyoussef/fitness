...
try {
    ...
    $categories = $workoutModel->getCategories() ?? [];
    $exercises = $workoutModel->getExercises() ?? [];
...
<head>
    ...
    <title>Create Workout - Fitness Tracker</title>
    ...
    .content {
        ...
        /* Adjusted top padding to account for header */
        min-height: 100vh;
        display: flex;
    ...
    .form-container {
        width: 100%;
        max-width: 700px;
        /* Slightly reduced for better fit with sidebar */
        margin: 0 auto;
    }
...
<body class="<?php echo isset($_SESSION['dark_mode']) && $_SESSION['dark_mode'] ? 'dark-mode' : ''; ?>">
    ...
    <div class="content">
        <div class="form-container">
            <h1 class="text-3xl font-bold mb-5">Create New Workout</h1>
            ...
            <form method="POST" action="/workout/create" class="card">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="duration" id="duration" class="form-control" rows="3" required>
                </div>
