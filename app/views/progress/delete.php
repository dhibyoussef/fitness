...
<body class="bg-gray-100">
    <div class="container mx-auto py-8">
        <h1 class="text-3xl font-bold mb-6 animate__animated animate__fadeIn">Delete Progress</h1>
        ...
        <div class="card shadow-sm p-4 animate__animated animate__fadeInUp">
            ...
            <form method="POST" action="/progress/delete/<?php echo $id; ?>">
