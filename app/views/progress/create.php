<?php
$pageTitle = $pageTitle ?? 'Log Progress';
...
<div class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a href="/workouts/index" class="nav-link">
...
<div class="content">
    <div class="container">
        ...
        <form method="POST" action="/progress/create" class="card">
            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf_token); ?>">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="body_fat" id="body_fat" class="form-control" step="0.1" required>
            </div>

            <div class="mb-3">
                <label for="muscle_mass" class="form-label">Muscle Mass (kg)</label>
                <input type="number" name="muscle_mass" id="muscle_mass" class="form-control" step="0.1">
            </div>
